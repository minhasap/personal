...
export const Skills = () => {
    ...
    const skillsGroups = useMemo(() => {
        const firstArray = SkillsList.concat(SkillsList.slice(8, 16));
    ...
    return (<section id={'skills'} className={'skills container'}>
        <div className={'skills__header'}>
            <p className={'skills__heading textestyleea'}>Skills</p>
            <p className={'skills__subheading textestyleee'}>Capabilities, I'm most proficient in</p>
        </div>
